...
def main():
    ...
    popt, pcov = curve_fit(Bass3, z, Sales_values, bounds=(0, np.inf), method='trf', maxfev = 10000)
    ...
    for n in metod_list:
        ...
        try:
            res = minimize(squareMistakeBass3, k0, args=(generate2, total2, costs2), method=n, bounds=kb)
        except:
        ...
        square = squareMistakeBass3(k, generate, total, costs)
